...
function App() {
  ...
  return (
    <div className="app">
      <div
        className={`App__container ${shrink && `shrink`} ${
          closeIcon && `close`
        }`}
      >
        <div className="App__navbar">
          ...
          <div className="right">
            <Remove onClick={handleCloseIcon}  />
      ...
      <div className="footer">
        <div className="icons">
          ...
          <div className={closeIcon && 'footer__close'} onClick={ handleOpenIcon}>
            <img src={cdm} />
          </div>
        </div>
